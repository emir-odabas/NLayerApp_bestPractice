        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_CategoriesTable_CategoryId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2022, 10, 27, 9, 47, 26, 207, DateTimeKind.Local).AddTicks(9342), "Kalem 1", 100m, 20, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreatedDate", "Name", "Price", "Stock", "UpdatedDate" },
                values: new object[] { 2, 2, new DateTime(2022, 10, 27, 9, 47, 26, 207, DateTimeKind.Local).AddTicks(9356), "Kitap 1", 200m, 30, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreatedDate", "Name", "Price", "Stock", "UpdatedDate" },
                values: new object[] { 3, 3, new DateTime(2022, 10, 27, 9, 47, 26, 207, DateTimeKind.Local).AddTicks(9357), "Defter 1", 300m, 40, null });
